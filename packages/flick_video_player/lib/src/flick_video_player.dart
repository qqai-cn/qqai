import 'package:flick_video_player/src/utils/flick_web_document.dart';
...
class FlickVideoPlayer extends StatefulWidget {
  const FlickVideoPlayer({
    ...
    FlickWebKeyDownHandler? webKeyDownHandler,
  })  : webKeyDownHandler = webKeyDownHandler ?? flickDefaultWebKeyDownHandler,
        super(key: key);
  ...
  final FlickWebKeyDownHandler webKeyDownHandler;
