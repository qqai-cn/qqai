...
class ShareImgDetailView extends ConsumerStatefulWidget {
  final ShareItem? blogItem;

  const ShareImgDetailView({super.key, this.blogItem});

  @override
  ConsumerState<ShareImgDetailView> createState() => _ShareImgDetailViewState();
}

class _ShareImgDetailViewState extends ConsumerState<ShareImgDetailView> {
