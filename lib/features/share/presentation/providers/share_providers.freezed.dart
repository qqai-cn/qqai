...
/// @nodoc
mixin _$ShareState {
  BlogPageModel? get blogPageModel;
  int? get total;
  List<BlogItem> get blogItems;
  bool get isLoading;
  String get error;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ShareState &&
            (identical(other.blogPageModel, blogPageModel) ||
                other.blogPageModel == blogPageModel) &&
            (identical(other.total, total) || other.total == total) &&
            const DeepCollectionEquality().equals(other.blogItems, blogItems) &&
  ...
  int get hashCode => Object.hash(
      ...
      blogPageModel,
      total,
      const DeepCollectionEquality().hash(blogItems),
      isLoading,
      error,
      scrollOffset);
  ...
  @override
  String toString() {
    return 'ShareState(blogPageModel: $blogPageModel, total: $total, blogItems: $blogItems, isLoading: $isLoading, error: $error, scrollOffset: $scrollOffset)';
  }
}
...
class _$ShareStateCopyWithImpl<$Res> implements $ShareStateCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? blogPageModel = freezed,
    Object? total = freezed,
    Object? blogItems = null,
    Object? isLoading = null,
    Object? error = null,
    Object? scrollOffset = null,
  }) {
    return _then(_self.copyWith(
      blogPageModel: freezed == blogPageModel
          ? _self.blogPageModel
          : blogPageModel // ignore: cast_nullable_to_non_nullable
              as BlogPageModel?,
      total: freezed == total
          ? _self.total
          : total // ignore: cast_nullable_to_non_nullable
              as int?,
      blogItems: null == blogItems
          ? _self.blogItems
          : blogItems // ignore: cast_nullable_to_non_nullable
              as List<BlogItem>,
...
extension ShareStatePatterns on ShareState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ShareState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ShareState() when $default != null:
        return $default(_that.blogPageModel, _that.total, _that.blogItems,
            _that.isLoading, _that.error, _that.scrollOffset);
      case _:
        return orElse();
    }
  }
...
class _ShareState implements ShareState {
  const _ShareState(
      {this.blogPageModel,
      this.total,
      final List<BlogItem> blogItems = const [],
  ...
  @override
  final BlogPageModel? blogPageModel;
  @override
  final int? total;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._blogItems, _blogItems) &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.error, error) || other.error == error) &&
            (identical(other.scrollOffset, scrollOffset) ||
  ...
  int get hashCode => Object.hash(
      ...
      blogPageModel,
      total,
      const DeepCollectionEquality().hash(_blogItems),
      isLoading,
      error,
      scrollOffset);
