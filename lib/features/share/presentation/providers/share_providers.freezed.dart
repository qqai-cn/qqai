...
class _ShareState implements ShareState {
  const _ShareState({this.blogPageModel, this.total, final  List<BlogItem> blogItems = const [], this.isLoading = false, this.error = '', this.scrollOffset = 0.0}): _blogItems = blogItems;
