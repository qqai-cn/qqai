...
mixin _$MessageState {
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(tabTitle), tabController);
...
abstract mixin class $MessageStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> tabTitle, TabController? tabController});
}
...
extension MessageStatePatterns on MessageState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MessageState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> tabTitle, TabController? tabController)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _MessageState implements MessageState {
  const _MessageState(
      {final List<String> tabTitle = const [], this.tabController})
      : _tabTitle = tabTitle;
  ...
  @override
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_tabTitle), tabController);
