...
mixin _$SquareItem {
 ...
 int? get id; String? get squareName; int? get userId; String? get userAvatar; String? get squareImg; String? get squareDesc; int? get areaId; String? get areaName; int? get chatConversationId; bool? get hasChatConversation; int? get blogCount; int? get followCount; bool? get followedByMe; String? get createTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,squareName,userId,userAvatar,squareImg,squareDesc,areaId,areaName,chatConversationId,hasChatConversation,blogCount,followCount,followedByMe,createTime);

@override
String toString() {
  return 'SquareItem(id: $id, squareName: $squareName, userId: $userId, userAvatar: $userAvatar, squareImg: $squareImg, squareDesc: $squareDesc, areaId: $areaId, areaName: $areaName, chatConversationId: $chatConversationId, hasChatConversation: $hasChatConversation, blogCount: $blogCount, followCount: $followCount, followedByMe: $followedByMe, createTime: $createTime)';
}
...
@useResult
$Res call({
 int? id, String? squareName, int? userId, String? userAvatar, String? squareImg, String? squareDesc, int? areaId, String? areaName, int? chatConversationId, bool? hasChatConversation, int? blogCount, int? followCount, bool? followedByMe, String? createTime
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? squareName,  int? userId,  String? userAvatar,  String? squareImg,  String? squareDesc,  int? areaId,  String? areaName,  int? chatConversationId,  bool? hasChatConversation,  int? blogCount,  int? followCount,  bool? followedByMe,  String? createTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SquareItem() when $default != null:
return $default(_that.id,_that.squareName,_that.userId,_that.userAvatar,_that.squareImg,_that.squareDesc,_that.areaId,_that.areaName,_that.chatConversationId,_that.hasChatConversation,_that.blogCount,_that.followCount,_that.followedByMe,_that.createTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? squareName,  int? userId,  String? userAvatar,  String? squareImg,  String? squareDesc,  int? areaId,  String? areaName,  int? chatConversationId,  bool? hasChatConversation,  int? blogCount,  int? followCount,  bool? followedByMe,  String? createTime)  $default,) {final _that = this;
switch (_that) {
case _SquareItem():
return $default(_that.id,_that.squareName,_that.userId,_that.userAvatar,_that.squareImg,_that.squareDesc,_that.areaId,_that.areaName,_that.chatConversationId,_that.hasChatConversation,_that.blogCount,_that.followCount,_that.followedByMe,_that.createTime);}
}
...
class _SquareItem implements SquareItem {
  const _SquareItem({this.id, this.squareName, this.userId, this.userAvatar, this.squareImg, this.squareDesc, this.areaId, this.areaName, this.chatConversationId, this.hasChatConversation, this.blogCount, this.followCount, this.followedByMe, this.createTime});
...
@override final  int? followCount;
