...
mixin _$SquareItem {
 ...
 int? get id; String? get squareName; int? get userId; String? get userAvatar; String? get squareImg; String? get squareDesc; int? get chatConversationId; bool? get hasChatConversation; int? get blogCount; String? get createTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,squareName,userId,userAvatar,squareImg,squareDesc,chatConversationId,hasChatConversation,blogCount,createTime);

@override
String toString() {
  return 'SquareItem(id: $id, squareName: $squareName, userId: $userId, userAvatar: $userAvatar, squareImg: $squareImg, squareDesc: $squareDesc, chatConversationId: $chatConversationId, hasChatConversation: $hasChatConversation, blogCount: $blogCount, createTime: $createTime)';
}
...
@useResult
$Res call({
 int? id, String? squareName, int? userId, String? userAvatar, String? squareImg, String? squareDesc, int? chatConversationId, bool? hasChatConversation, int? blogCount, String? createTime
});
...
/// Create a copy of SquareItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? squareName = freezed,Object? userId = freezed,Object? userAvatar = freezed,Object? squareImg = freezed,Object? squareDesc = freezed,Object? chatConversationId = freezed,Object? hasChatConversation = freezed,Object? blogCount = freezed,Object? createTime = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? squareName,  int? userId,  String? userAvatar,  String? squareImg,  String? squareDesc,  int? chatConversationId,  bool? hasChatConversation,  int? blogCount,  String? createTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SquareItem() when $default != null:
return $default(_that.id,_that.squareName,_that.userId,_that.userAvatar,_that.squareImg,_that.squareDesc,_that.chatConversationId,_that.hasChatConversation,_that.blogCount,_that.createTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? squareName,  int? userId,  String? userAvatar,  String? squareImg,  String? squareDesc,  int? chatConversationId,  bool? hasChatConversation,  int? blogCount,  String? createTime)  $default,) {final _that = this;
switch (_that) {
case _SquareItem():
return $default(_that.id,_that.squareName,_that.userId,_that.userAvatar,_that.squareImg,_that.squareDesc,_that.chatConversationId,_that.hasChatConversation,_that.blogCount,_that.createTime);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? squareName,  int? userId,  String? userAvatar,  String? squareImg,  String? squareDesc,  int? chatConversationId,  bool? hasChatConversation,  int? blogCount,  String? createTime)?  $default,) {final _that = this;
switch (_that) {
case _SquareItem() when $default != null:
return $default(_that.id,_that.squareName,_that.userId,_that.userAvatar,_that.squareImg,_that.squareDesc,_that.chatConversationId,_that.hasChatConversation,_that.blogCount,_that.createTime);case _:
  return null;
...
class _SquareItem implements SquareItem {
  const _SquareItem({this.id, this.squareName, this.userId, this.userAvatar, this.squareImg, this.squareDesc, this.chatConversationId, this.hasChatConversation, this.blogCount, this.createTime});
...
/// Create a copy of SquareItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? squareName = freezed,Object? userId = freezed,Object? userAvatar = freezed,Object? squareImg = freezed,Object? squareDesc = freezed,Object? chatConversationId = freezed,Object? hasChatConversation = freezed,Object? blogCount = freezed,Object? createTime = freezed,}) {
