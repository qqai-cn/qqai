...
class ImageFlowPage extends ConsumerStatefulWidget {
  final BlogItem? blogItem;

  const ImageFlowPage({super.key, this.blogItem});

  @override
  ConsumerState<ImageFlowPage> createState() => _ImageFlowPage();
}

class _ImageFlowPage extends ConsumerState<ImageFlowPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrls =
        widget.blogItem!.resources
            ...
            .toList() ??
        [];
    final imageWidgets = imageUrls.map((url) {
      return Container(
