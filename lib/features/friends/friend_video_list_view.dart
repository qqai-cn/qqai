...
class FriendVideoListView extends StatefulWidget {
  final int tabIndex;
  final int currentIndex; // 当前选中的 Tab index

  const FriendVideoListView({
    required this.tabIndex,
    required this.currentIndex,
  });

  @override
  State<FriendVideoListView> createState() => _TabPageState();
}

class _TabPageState extends State<FriendVideoListView>
