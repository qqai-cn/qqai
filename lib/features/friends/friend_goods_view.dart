...
class FriendGoodsView extends StatefulWidget {
  final int tabIndex;
  final int currentIndex; // 当前选中的 Tab index

  const FriendGoodsView({required this.tabIndex, required this.currentIndex});

  @override
  State<FriendGoodsView> createState() => _TabPageState();
}

class _TabPageState extends State<FriendGoodsView>
