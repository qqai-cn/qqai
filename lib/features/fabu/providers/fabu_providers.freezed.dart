...
// freezed 的 @Default 必须是 const
 AsyncValue<List<FabuModel>> get items; List<XFile> get files; List<XFile> get videoFiles; XFile? get coverFile; Uint8List? get coverPreviewBytes; List<String> get uploadedFileUrls; List<String> get uploadedVideoUrls; String? get uploadedCoverUrl; int get selectedCoverStyleId; List<AddressEntity> get addressList; List<SkuuTopicResVO> get topicList; List<String> get whoCanSee; AddressEntity? get selAddressEntity; int? get whoCanSeeSel; int get aixinType; Map<int, String> get huatiSel; String? get error; bool get isLoading; bool get isUploading; bool get isCoverUploading; bool get isCoverPreviewing; String get textContent; bool get isLoadingGPS; double get publishProgress; String get publishStage;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('items', items))..add(DiagnosticsProperty('files', files))..add(DiagnosticsProperty('videoFiles', videoFiles))..add(DiagnosticsProperty('coverFile', coverFile))..add(DiagnosticsProperty('coverPreviewBytes', coverPreviewBytes))..add(DiagnosticsProperty('uploadedFileUrls', uploadedFileUrls))..add(DiagnosticsProperty('uploadedVideoUrls', uploadedVideoUrls))..add(DiagnosticsProperty('uploadedCoverUrl', uploadedCoverUrl))..add(DiagnosticsProperty('selectedCoverStyleId', selectedCoverStyleId))..add(DiagnosticsProperty('addressList', addressList))..add(DiagnosticsProperty('topicList', topicList))..add(DiagnosticsProperty('whoCanSee', whoCanSee))..add(DiagnosticsProperty('selAddressEntity', selAddressEntity))..add(DiagnosticsProperty('whoCanSeeSel', whoCanSeeSel))..add(DiagnosticsProperty('aixinType', aixinType))..add(DiagnosticsProperty('huatiSel', huatiSel))..add(DiagnosticsProperty('error', error))..add(DiagnosticsProperty('isLoading', isLoading))..add(DiagnosticsProperty('isUploading', isUploading))..add(DiagnosticsProperty('isCoverUploading', isCoverUploading))..add(DiagnosticsProperty('isCoverPreviewing', isCoverPreviewing))..add(DiagnosticsProperty('textContent', textContent))..add(DiagnosticsProperty('isLoadingGPS', isLoadingGPS))..add(DiagnosticsProperty('publishProgress', publishProgress))..add(DiagnosticsProperty('publishStage', publishStage));
}
...
@override
int get hashCode => Object.hashAll([runtimeType,items,const DeepCollectionEquality().hash(files),const DeepCollectionEquality().hash(videoFiles),coverFile,const DeepCollectionEquality().hash(coverPreviewBytes),const DeepCollectionEquality().hash(uploadedFileUrls),const DeepCollectionEquality().hash(uploadedVideoUrls),uploadedCoverUrl,selectedCoverStyleId,const DeepCollectionEquality().hash(addressList),const DeepCollectionEquality().hash(topicList),const DeepCollectionEquality().hash(whoCanSee),selAddressEntity,whoCanSeeSel,aixinType,const DeepCollectionEquality().hash(huatiSel),error,isLoading,isUploading,isCoverUploading,isCoverPreviewing,textContent,isLoadingGPS,publishProgress,publishStage]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'FabuState(items: $items, files: $files, videoFiles: $videoFiles, coverFile: $coverFile, coverPreviewBytes: $coverPreviewBytes, uploadedFileUrls: $uploadedFileUrls, uploadedVideoUrls: $uploadedVideoUrls, uploadedCoverUrl: $uploadedCoverUrl, selectedCoverStyleId: $selectedCoverStyleId, addressList: $addressList, topicList: $topicList, whoCanSee: $whoCanSee, selAddressEntity: $selAddressEntity, whoCanSeeSel: $whoCanSeeSel, aixinType: $aixinType, huatiSel: $huatiSel, error: $error, isLoading: $isLoading, isUploading: $isUploading, isCoverUploading: $isCoverUploading, isCoverPreviewing: $isCoverPreviewing, textContent: $textContent, isLoadingGPS: $isLoadingGPS, publishProgress: $publishProgress, publishStage: $publishStage)';
}
...
@useResult
$Res call({
 AsyncValue<List<FabuModel>> items, List<XFile> files, List<XFile> videoFiles, XFile? coverFile, Uint8List? coverPreviewBytes, List<String> uploadedFileUrls, List<String> uploadedVideoUrls, String? uploadedCoverUrl, int selectedCoverStyleId, List<AddressEntity> addressList, List<SkuuTopicResVO> topicList, List<String> whoCanSee, AddressEntity? selAddressEntity, int? whoCanSeeSel, int aixinType, Map<int, String> huatiSel, String? error, bool isLoading, bool isUploading, bool isCoverUploading, bool isCoverPreviewing, String textContent, bool isLoadingGPS, double publishProgress, String publishStage
});
...
/// Create a copy of FabuState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? files = null,Object? videoFiles = null,Object? coverFile = freezed,Object? coverPreviewBytes = freezed,Object? uploadedFileUrls = null,Object? uploadedVideoUrls = null,Object? uploadedCoverUrl = freezed,Object? selectedCoverStyleId = null,Object? addressList = null,Object? topicList = null,Object? whoCanSee = null,Object? selAddressEntity = freezed,Object? whoCanSeeSel = freezed,Object? aixinType = null,Object? huatiSel = null,Object? error = freezed,Object? isLoading = null,Object? isUploading = null,Object? isCoverUploading = null,Object? isCoverPreviewing = null,Object? textContent = null,Object? isLoadingGPS = null,Object? publishProgress = null,Object? publishStage = null,}) {
...
as String?,selectedCoverStyleId: null == selectedCoverStyleId ? _self.selectedCoverStyleId : selectedCoverStyleId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AsyncValue<List<FabuModel>> items,  List<XFile> files,  List<XFile> videoFiles,  XFile? coverFile,  Uint8List? coverPreviewBytes,  List<String> uploadedFileUrls,  List<String> uploadedVideoUrls,  String? uploadedCoverUrl,  int selectedCoverStyleId,  List<AddressEntity> addressList,  List<SkuuTopicResVO> topicList,  List<String> whoCanSee,  AddressEntity? selAddressEntity,  int? whoCanSeeSel,  int aixinType,  Map<int, String> huatiSel,  String? error,  bool isLoading,  bool isUploading,  bool isCoverUploading,  bool isCoverPreviewing,  String textContent,  bool isLoadingGPS,  double publishProgress,  String publishStage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FabuState() when $default != null:
return $default(_that.items,_that.files,_that.videoFiles,_that.coverFile,_that.coverPreviewBytes,_that.uploadedFileUrls,_that.uploadedVideoUrls,_that.uploadedCoverUrl,_that.selectedCoverStyleId,_that.addressList,_that.topicList,_that.whoCanSee,_that.selAddressEntity,_that.whoCanSeeSel,_that.aixinType,_that.huatiSel,_that.error,_that.isLoading,_that.isUploading,_that.isCoverUploading,_that.isCoverPreviewing,_that.textContent,_that.isLoadingGPS,_that.publishProgress,_that.publishStage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AsyncValue<List<FabuModel>> items,  List<XFile> files,  List<XFile> videoFiles,  XFile? coverFile,  Uint8List? coverPreviewBytes,  List<String> uploadedFileUrls,  List<String> uploadedVideoUrls,  String? uploadedCoverUrl,  int selectedCoverStyleId,  List<AddressEntity> addressList,  List<SkuuTopicResVO> topicList,  List<String> whoCanSee,  AddressEntity? selAddressEntity,  int? whoCanSeeSel,  int aixinType,  Map<int, String> huatiSel,  String? error,  bool isLoading,  bool isUploading,  bool isCoverUploading,  bool isCoverPreviewing,  String textContent,  bool isLoadingGPS,  double publishProgress,  String publishStage)  $default,) {final _that = this;
switch (_that) {
case _FabuState():
return $default(_that.items,_that.files,_that.videoFiles,_that.coverFile,_that.coverPreviewBytes,_that.uploadedFileUrls,_that.uploadedVideoUrls,_that.uploadedCoverUrl,_that.selectedCoverStyleId,_that.addressList,_that.topicList,_that.whoCanSee,_that.selAddressEntity,_that.whoCanSeeSel,_that.aixinType,_that.huatiSel,_that.error,_that.isLoading,_that.isUploading,_that.isCoverUploading,_that.isCoverPreviewing,_that.textContent,_that.isLoadingGPS,_that.publishProgress,_that.publishStage);}
}
...
class _FabuState with DiagnosticableTreeMixin implements FabuState {
  const _FabuState({this.items = const AsyncLoading(), final  List<XFile> files = const [], final  List<XFile> videoFiles = const [], this.coverFile, this.coverPreviewBytes, final  List<String> uploadedFileUrls = const [], final  List<String> uploadedVideoUrls = const [], this.uploadedCoverUrl, this.selectedCoverStyleId = 1, final  List<AddressEntity> addressList = const [], final  List<SkuuTopicResVO> topicList = const [], final  List<String> whoCanSee = const ['公开', '仅自己可见', '部分好友可见', '部分好友不可见'], this.selAddressEntity, this.whoCanSeeSel = 0, this.aixinType = 0, final  Map<int, String> huatiSel = const {}, this.error, this.isLoading = false, this.isUploading = false, this.isCoverUploading = false, this.isCoverPreviewing = false, this.textContent = '', this.isLoadingGPS = false, this.publishProgress = 0.0, this.publishStage = ''}): _files = files,_videoFiles = videoFiles,_uploadedFileUrls = uploadedFileUrls,_uploadedVideoUrls = uploadedVideoUrls,_addressList = addressList,_topicList = topicList,_whoCanSee = whoCanSee,_huatiSel = huatiSel;
...
@override
int get hashCode => Object.hashAll([runtimeType,items,const DeepCollectionEquality().hash(_files),const DeepCollectionEquality().hash(_videoFiles),coverFile,const DeepCollectionEquality().hash(coverPreviewBytes),const DeepCollectionEquality().hash(_uploadedFileUrls),const DeepCollectionEquality().hash(_uploadedVideoUrls),uploadedCoverUrl,selectedCoverStyleId,const DeepCollectionEquality().hash(_addressList),const DeepCollectionEquality().hash(_topicList),const DeepCollectionEquality().hash(_whoCanSee),selAddressEntity,whoCanSeeSel,aixinType,const DeepCollectionEquality().hash(_huatiSel),error,isLoading,isUploading,isCoverUploading,isCoverPreviewing,textContent,isLoadingGPS,publishProgress,publishStage]);
...
/// Create a copy of FabuState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? files = null,Object? videoFiles = null,Object? coverFile = freezed,Object? coverPreviewBytes = freezed,Object? uploadedFileUrls = null,Object? uploadedVideoUrls = null,Object? uploadedCoverUrl = freezed,Object? selectedCoverStyleId = null,Object? addressList = null,Object? topicList = null,Object? whoCanSee = null,Object? selAddressEntity = freezed,Object? whoCanSeeSel = freezed,Object? aixinType = null,Object? huatiSel = null,Object? error = freezed,Object? isLoading = null,Object? isUploading = null,Object? isCoverUploading = null,Object? isCoverPreviewing = null,Object? textContent = null,Object? isLoadingGPS = null,Object? publishProgress = null,Object? publishStage = null,}) {
