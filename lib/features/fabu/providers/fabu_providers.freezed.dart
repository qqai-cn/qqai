...
/// Create a copy of FabuState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? files = null,Object? videoFiles = null,Object? coverFile = freezed,Object? uploadedFileUrls = null,Object? uploadedVideoUrls = null,Object? uploadedCoverUrl = freezed,Object? selectedCoverStyleId = null,Object? addressList = null,Object? topicList = null,Object? whoCanSee = null,Object? selAddressEntity = freezed,Object? whoCanSeeSel = freezed,Object? aixinType = null,Object? huatiSel = null,Object? error = freezed,Object? isLoading = null,Object? isUploading = null,Object? isCoverUploading = null,Object? textContent = null,Object? isLoadingGPS = null,}) {
...
as XFile?,uploadedFileUrls: null == uploadedFileUrls ? _self.uploadedFileUrls : uploadedFileUrls // ignore: cast_nullable_to_non_nullable
...
class _FabuState implements FabuState {
  const _FabuState({this.items = const AsyncLoading(), final  List<XFile> files = const [], final  List<XFile> videoFiles = const [], this.coverFile, final  List<String> uploadedFileUrls = const [], final  List<String> uploadedVideoUrls = const [], this.uploadedCoverUrl, this.selectedCoverStyleId = 1, final  List<AddressEntity> addressList = const [], final  List<SkuuTopicResVO> topicList = const [], final  List<String> whoCanSee = const ['公开', '仅自己可见', '部分好友可见', '部分好友不可见'], this.selAddressEntity, this.whoCanSeeSel = 0, this.aixinType = 0, final  Map<int, String> huatiSel = const {}, this.error, this.isLoading = false, this.isUploading = false, this.isCoverUploading = false, this.textContent = '', this.isLoadingGPS = false}): _files = files,_videoFiles = videoFiles,_uploadedFileUrls = uploadedFileUrls,_uploadedVideoUrls = uploadedVideoUrls,_addressList = addressList,_topicList = topicList,_whoCanSee = whoCanSee,_huatiSel = huatiSel;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FabuState&&(identical(other.items, items) || other.items == items)&&const DeepCollectionEquality().equals(other._files, _files)&&const DeepCollectionEquality().equals(other._videoFiles, _videoFiles)&&(identical(other.coverFile, coverFile) || other.coverFile == coverFile)&&const DeepCollectionEquality().equals(other._uploadedFileUrls, _uploadedFileUrls)&&const DeepCollectionEquality().equals(other._uploadedVideoUrls, _uploadedVideoUrls)&&(identical(other.uploadedCoverUrl, uploadedCoverUrl) || other.uploadedCoverUrl == uploadedCoverUrl)&&(identical(other.selectedCoverStyleId, selectedCoverStyleId) || other.selectedCoverStyleId == selectedCoverStyleId)&&const DeepCollectionEquality().equals(other._addressList, _addressList)&&const DeepCollectionEquality().equals(other._topicList, _topicList)&&const DeepCollectionEquality().equals(other._whoCanSee, _whoCanSee)&&(identical(other.selAddressEntity, selAddressEntity) || other.selAddressEntity == selAddressEntity)&&(identical(other.whoCanSeeSel, whoCanSeeSel) || other.whoCanSeeSel == whoCanSeeSel)&&(identical(other.aixinType, aixinType) || other.aixinType == aixinType)&&const DeepCollectionEquality().equals(other._huatiSel, _huatiSel)&&(identical(other.error, error) || other.error == error)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isUploading, isUploading) || other.isUploading == isUploading)&&(identical(other.isCoverUploading, isCoverUploading) || other.isCoverUploading == isCoverUploading)&&(identical(other.textContent, textContent) || other.textContent == textContent)&&(identical(other.isLoadingGPS, isLoadingGPS) || other.isLoadingGPS == isLoadingGPS));
}


@override
int get hashCode => Object.hashAll([runtimeType,items,const DeepCollectionEquality().hash(_files),const DeepCollectionEquality().hash(_videoFiles),coverFile,const DeepCollectionEquality().hash(_uploadedFileUrls),const DeepCollectionEquality().hash(_uploadedVideoUrls),uploadedCoverUrl,selectedCoverStyleId,const DeepCollectionEquality().hash(_addressList),const DeepCollectionEquality().hash(_topicList),const DeepCollectionEquality().hash(_whoCanSee),selAddressEntity,whoCanSeeSel,aixinType,const DeepCollectionEquality().hash(_huatiSel),error,isLoading,isUploading,isCoverUploading,textContent,isLoadingGPS]);
...
/// Create a copy of FabuState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? files = null,Object? videoFiles = null,Object? coverFile = freezed,Object? uploadedFileUrls = null,Object? uploadedVideoUrls = null,Object? uploadedCoverUrl = freezed,Object? selectedCoverStyleId = null,Object? addressList = null,Object? topicList = null,Object? whoCanSee = null,Object? selAddressEntity = freezed,Object? whoCanSeeSel = freezed,Object? aixinType = null,Object? huatiSel = null,Object? error = freezed,Object? isLoading = null,Object? isUploading = null,Object? isCoverUploading = null,Object? textContent = null,Object? isLoadingGPS = null,}) {
...
as List<XFile>,coverFile: freezed == coverFile ? _self.coverFile : coverFile // ignore: cast_nullable_to_non_nullable
as XFile?,uploadedFileUrls: null == uploadedFileUrls ? _self._uploadedFileUrls : uploadedFileUrls // ignore: cast_nullable_to_non_nullable
