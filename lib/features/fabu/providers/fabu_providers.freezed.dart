...
@override
int get hashCode => Object.hashAll([runtimeType,items,const DeepCollectionEquality().hash(_files),const DeepCollectionEquality().hash(_videoFiles),coverFile,const DeepCollectionEquality().hash(coverPreviewBytes),const DeepCollectionEquality().hash(_uploadedFileUrls),const DeepCollectionEquality().hash(_uploadedVideoUrls),uploadedCoverUrl,selectedCoverStyleId,const DeepCollectionEquality().hash(_addressList),const DeepCollectionEquality().hash(_topicList),const DeepCollectionEquality().hash(_whoCanSee),selAddressEntity,whoCanSeeSel,aixinType,const DeepCollectionEquality().hash(_huatiSel),error,isLoading,isUploading,isCoverUploading,isCoverPreviewing,textContent,blogTitle,isLoadingGPS,publishProgress,publishStage]);
