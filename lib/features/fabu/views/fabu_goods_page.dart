...
class FabuGoodsPage extends ConsumerStatefulWidget {
  @override
  ConsumerState<FabuGoodsPage> createState() => _FabuGoodsPage();
}

class _FabuGoodsPage extends ConsumerState<FabuGoodsPage> {
  late TextEditingController goodsEditingController;
  ...
  void initState() {
    super.initState();
    goodsEditingController = TextEditingController();
  ...
  void dispose() {
    super.dispose();
    goodsEditingController.dispose();
