...
class FabuAiXinPage extends ConsumerStatefulWidget {
  @override
  ConsumerState<FabuAiXinPage> createState() => _FabuAiXinPage();
}

class _FabuAiXinPage extends ConsumerState<FabuAiXinPage> {
        ...
        child: ListView(
          ...
          children: [
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        ///输入框获取焦点时才会显示出来 输入文本的前面
                        prefixText: "目标：",
                        prefixStyle: context.typo.bodyStrong.copyWith(
                          color: Colors.blue,
                        ),
            ...
            ListTile(
              ...
              title: buildRadioGroupRowWidget(fabuState, fabuNotifier),
            ),
            Divider(
              height: 1,
              color: Colors.black12,
                ...
                showModalBottomSheet(
                  ...
                  builder: (BuildContext build) {
                    return Padding(
                      padding: EdgeInsets.only(top: 50.h),
                      child: ListView.separated(
                        itemCount: fabuState.whoCanSee.length,
                        itemBuilder: (BuildContext context, int index) {
                          return ListTile(
                            title: Text(fabuState.whoCanSee[index]),
                            trailing: fabuState.whoCanSeeSel == index
                                ? const Icon(Icons.check)
                                : null,
                            onTap: () {
                              fabuNotifier.setWhoCanSee(index);
                              Navigator.pop(context);
                            },
                          );
                        },
  ...
  Future<List<XFile>> _openImageFile(
  ...
  Row buildRadioGroupRowWidget(FabuState fabuState, FabuNotifier fabuNotifier) {
    return Row(
      children: [
        Row(
          ///包裹子布局
          ...
          children: [
            Radio(
              ...
              ///当前组中这选定的值  必选参数
              groupValue: fabuState.aixinType,

              ///点击状态改变时的回调 必选参数
              onChanged: (v) {
                fabuNotifier.changeAiXinType(v!);
              },
            ),
            Text("聚力"),
          ],
