...
mixin _$FabuGoodsState {
  ...
  $FabuGoodsStateCopyWith<FabuGoodsState> get copyWith =>
      _$FabuGoodsStateCopyWithImpl<FabuGoodsState>(
          this as FabuGoodsState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FabuGoodsState &&
            ...
            const DeepCollectionEquality()
                .equals(other.selAddressEntity, selAddressEntity) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(selAddressEntity),
      whoCanSeeSel,
...
abstract mixin class $FabuGoodsStateCopyWith<$Res> {
  factory $FabuGoodsStateCopyWith(
          FabuGoodsState value, $Res Function(FabuGoodsState) _then) =
      _$FabuGoodsStateCopyWithImpl;
  @useResult
  $Res call(
...
extension FabuGoodsStatePatterns on FabuGoodsState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FabuGoodsState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _FabuGoodsState() when $default != null:
        return $default(
            _that.titleController,
            _that.contentController,
            _that.priceController,
            _that.files,
            _that.videoFiles,
            _that.addressList,
            _that.whoCanSee,
...
class _FabuGoodsState implements FabuGoodsState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FabuGoodsStateCopyWith<_FabuGoodsState> get copyWith =>
      __$FabuGoodsStateCopyWithImpl<_FabuGoodsState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FabuGoodsState &&
            (identical(other.titleController, titleController) ||
                other.titleController == titleController) &&
            (identical(other.contentController, contentController) ||
                other.contentController == contentController) &&
...
/// @nodoc
abstract mixin class _$FabuGoodsStateCopyWith<$Res>
    implements $FabuGoodsStateCopyWith<$Res> {
  factory _$FabuGoodsStateCopyWith(
          _FabuGoodsState value, $Res Function(_FabuGoodsState) _then) =
      __$FabuGoodsStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {TextEditingController titleController,
