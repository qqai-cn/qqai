...
part 'fabu_goods_providers.freezed.dart';
part 'fabu_goods_providers.g.dart';

// FabuGoodsController 状态 - 使用 Freezed
@freezed
sealed class FabuGoodsState with _$FabuGoodsState {
  const factory FabuGoodsState({
  ...
  // 工厂构造函数用于初始化
  factory FabuGoodsState.initial() => FabuGoodsState(
...
// FabuGoodsController Provider - 使用 Riverpod 3 代码生成（autoDispose）
@Riverpod(keepAlive: false)
class FabuGoodsNotifier extends _$FabuGoodsNotifier {
  @override
  FabuGoodsState build() {
    final state = FabuGoodsState.initial();
    ref.onDispose(() {
...
// Provider 已通过代码生成自动创建为 fabuGoodsNotifierProvider
