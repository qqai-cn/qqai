...
class FabuZuoPinPage extends ConsumerStatefulWidget {
  const FabuZuoPinPage({super.key});

  @override
  ConsumerState<FabuZuoPinPage> createState() => _FabuZuoPinPageState();
}

class _FabuZuoPinPageState extends ConsumerState<FabuZuoPinPage>
  ...
  late final List<Widget> _tabBoby = const [
    FabuDynamicPage(),
    FabuVideoPage(),
    FabuGoodsPage(),
    FabuAiXinPage(),
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              ...
              if (index == 0) {
                // 发布动态
                ref.read(fabuDynamicProvider.notifier).fabu();
              } else if (index == 1) {
                // 发布视频
                // TODO: 实现发布视频逻辑
              } else if (index == 2) {
