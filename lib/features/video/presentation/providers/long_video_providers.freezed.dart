...
mixin _$LongVideoState {
  ...
  $LongVideoStateCopyWith<LongVideoState> get copyWith =>
      _$LongVideoStateCopyWithImpl<LongVideoState>(
          this as LongVideoState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LongVideoState &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(videoItems));
...
abstract mixin class $LongVideoStateCopyWith<$Res> {
  factory $LongVideoStateCopyWith(
          LongVideoState value, $Res Function(LongVideoState) _then) =
      _$LongVideoStateCopyWithImpl;
  @useResult
  $Res call({List<String> videoItems});
}
...
extension LongVideoStatePatterns on LongVideoState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LongVideoState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> videoItems)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _LongVideoState implements LongVideoState {
  const _LongVideoState({final List<String> videoItems = const []})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LongVideoStateCopyWith<_LongVideoState> get copyWith =>
      __$LongVideoStateCopyWithImpl<_LongVideoState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LongVideoState &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_videoItems));
...
/// @nodoc
abstract mixin class _$LongVideoStateCopyWith<$Res>
    implements $LongVideoStateCopyWith<$Res> {
  factory _$LongVideoStateCopyWith(
          _LongVideoState value, $Res Function(_LongVideoState) _then) =
      __$LongVideoStateCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> videoItems});
}
