...
class _HelpState implements HelpState {
  const _HelpState({this.blogPageModel, this.total, final  List<BlogItem> blogItems = const [], this.isLoading = false, this.error = '', this.scrollOffset = 0.0}): _blogItems = blogItems;
