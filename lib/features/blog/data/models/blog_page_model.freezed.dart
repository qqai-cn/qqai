...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,videoWidth,videoHeight,videoAspectRatio,backgroundMusicUrl,backgroundMusicName,soundMode,addressId,address,latitude,longitude,distance,shareType,zan,commentCount,collectCount,shareCount,care,followerCount,creator,creatorName,creatorAvatar,creatorLevel,creatorLevelName,updater,createTime,updateTime,liked,collect,const DeepCollectionEquality().hash(collections)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,videoWidth,videoHeight,videoAspectRatio,backgroundMusicUrl,backgroundMusicName,soundMode,addressId,address,latitude,longitude,distance,shareType,zan,commentCount,collectCount,shareCount,care,followerCount,creator,creatorName,creatorAvatar,creatorLevel,creatorLevelName,updater,createTime,updateTime,liked,collect,const DeepCollectionEquality().hash(_collections)]);
