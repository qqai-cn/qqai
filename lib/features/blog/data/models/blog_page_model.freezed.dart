...
mixin _$BlogItem {
 ...
 int? get id; int? get userId; int? get squareId; String? get topicIds; int? get categary; int? get blogType; String? get content; String? get resources; String? get coverUrl; int? get addressId; String? get address; double? get latitude; double? get longitude;/// 与当前位置距离（千米，附近列表时有值）
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,squareId,topicIds,categary,blogType,content,resources,coverUrl,addressId,address,latitude,longitude,distance,shareType,zan,commentCount,collectCount,shareCount,care,followerCount,creator,creatorName,creatorAvatar,creatorLevel,creatorLevelName,updater,createTime,updateTime,liked,collect]);

@override
String toString() {
  return 'BlogItem(id: $id, userId: $userId, squareId: $squareId, topicIds: $topicIds, categary: $categary, blogType: $blogType, content: $content, resources: $resources, coverUrl: $coverUrl, addressId: $addressId, address: $address, latitude: $latitude, longitude: $longitude, distance: $distance, shareType: $shareType, zan: $zan, commentCount: $commentCount, collectCount: $collectCount, shareCount: $shareCount, care: $care, followerCount: $followerCount, creator: $creator, creatorName: $creatorName, creatorAvatar: $creatorAvatar, creatorLevel: $creatorLevel, creatorLevelName: $creatorLevelName, updater: $updater, createTime: $createTime, updateTime: $updateTime, liked: $liked, collect: $collect)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BlogItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect)  $default,) {final _that = this;
switch (_that) {
case _BlogItem():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect)?  $default,) {final _that = this;
switch (_that) {
case _BlogItem() when $default != null:
return $default(_that.id,_that.userId,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.content,_that.resources,_that.coverUrl,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.distance,_that.shareType,_that.zan,_that.commentCount,_that.collectCount,_that.shareCount,_that.care,_that.followerCount,_that.creator,_that.creatorName,_that.creatorAvatar,_that.creatorLevel,_that.creatorLevelName,_that.updater,_that.createTime,_that.updateTime,_that.liked,_that.collect);case _:
  return null;
