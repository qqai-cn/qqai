...
mixin _$BlogItem {
 ...
 int? get id; int? get userId; int? get squareId; String? get topicIds; int? get categary; int? get blogType; String? get content; String? get resources; int? get addressId; String? get address; double? get latitude; double? get longitude;/// 与当前位置距离（千米，附近列表时有值）
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,squareId,topicIds,categary,blogType,content,resources,addressId,address,latitude,longitude,distance,shareType,zan,commentCount,collectCount,shareCount,care,followerCount,creator,creatorName,creatorAvatar,creatorLevel,creatorLevelName,updater,createTime,updateTime,liked,collect]);

@override
String toString() {
  return 'BlogItem(id: $id, userId: $userId, squareId: $squareId, topicIds: $topicIds, categary: $categary, blogType: $blogType, content: $content, resources: $resources, addressId: $addressId, address: $address, latitude: $latitude, longitude: $longitude, distance: $distance, shareType: $shareType, zan: $zan, commentCount: $commentCount, collectCount: $collectCount, shareCount: $shareCount, care: $care, followerCount: $followerCount, creator: $creator, creatorName: $creatorName, creatorAvatar: $creatorAvatar, creatorLevel: $creatorLevel, creatorLevelName: $creatorLevelName, updater: $updater, createTime: $createTime, updateTime: $updateTime, liked: $liked, collect: $collect)';
}
