...
mixin _$BlogItem {
 ...
 int? get id; int? get userId; int? get squareId; String? get topicIds; int? get categary; int? get blogType; String? get title; String? get content; String? get resources; String? get coverUrl; int? get videoWidth; int? get videoHeight; double? get videoAspectRatio; String? get backgroundMusicUrl; String? get backgroundMusicName; int? get soundMode; int? get addressId; String? get address; double? get latitude; double? get longitude;/// 与当前位置距离（千米，附近列表时有值）
 ...
 List<BlogItemCollection>? get collections;/// 挂载的店铺商品（团购带货）
 List<BlogItemShopProduct>? get shopProducts;
...
@useResult
$Res call({
 int? id, int? userId, int? squareId, String? topicIds, int? categary, int? blogType, String? title, String? content, String? resources, String? coverUrl, int? videoWidth, int? videoHeight, double? videoAspectRatio, String? backgroundMusicUrl, String? backgroundMusicName, int? soundMode, int? addressId, String? address, double? latitude, double? longitude, double? distance, int? shareType, int? zan, int? commentCount, int? collectCount, int? shareCount, int? care, int? followerCount, String? creator, String? creatorName, String? creatorAvatar, int? creatorLevel, String? creatorLevelName, String? updater, String? createTime, String? updateTime, int? liked, int? collect, List<BlogItemCollection>? collections, List<BlogItemShopProduct>? shopProducts
});
...
/// Create a copy of BlogItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? userId = freezed,Object? squareId = freezed,Object? topicIds = freezed,Object? categary = freezed,Object? blogType = freezed,Object? title = freezed,Object? content = freezed,Object? resources = freezed,Object? coverUrl = freezed,Object? videoWidth = freezed,Object? videoHeight = freezed,Object? videoAspectRatio = freezed,Object? backgroundMusicUrl = freezed,Object? backgroundMusicName = freezed,Object? soundMode = freezed,Object? addressId = freezed,Object? address = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? distance = freezed,Object? shareType = freezed,Object? zan = freezed,Object? commentCount = freezed,Object? collectCount = freezed,Object? shareCount = freezed,Object? care = freezed,Object? followerCount = freezed,Object? creator = freezed,Object? creatorName = freezed,Object? creatorAvatar = freezed,Object? creatorLevel = freezed,Object? creatorLevelName = freezed,Object? updater = freezed,Object? createTime = freezed,Object? updateTime = freezed,Object? liked = freezed,Object? collect = freezed,Object? collections = freezed,Object? shopProducts = freezed,}) {
...
as double?,backgroundMusicUrl: freezed == backgroundMusicUrl ? _self.backgroundMusicUrl : backgroundMusicUrl // ignore: cast_nullable_to_non_nullable
...
as String?,soundMode: freezed == soundMode ? _self.soundMode : soundMode // ignore: cast_nullable_to_non_nullable
...
as List<BlogItemCollection>?,shopProducts: freezed == shopProducts ? _self.shopProducts : shopProducts // ignore: cast_nullable_to_non_nullable
as List<BlogItemShopProduct>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? videoWidth,  int? videoHeight,  double? videoAspectRatio,  String? backgroundMusicUrl,  String? backgroundMusicName,  int? soundMode,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect,  List<BlogItemCollection>? collections,  List<BlogItemShopProduct>? shopProducts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BlogItem() when $default != null:
return $default(_that.id,_that.userId,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.videoWidth,_that.videoHeight,_that.videoAspectRatio,_that.backgroundMusicUrl,_that.backgroundMusicName,_that.soundMode,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.distance,_that.shareType,_that.zan,_that.commentCount,_that.collectCount,_that.shareCount,_that.care,_that.followerCount,_that.creator,_that.creatorName,_that.creatorAvatar,_that.creatorLevel,_that.creatorLevelName,_that.updater,_that.createTime,_that.updateTime,_that.liked,_that.collect,_that.collections,_that.shopProducts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? videoWidth,  int? videoHeight,  double? videoAspectRatio,  String? backgroundMusicUrl,  String? backgroundMusicName,  int? soundMode,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect,  List<BlogItemCollection>? collections,  List<BlogItemShopProduct>? shopProducts)  $default,) {final _that = this;
switch (_that) {
case _BlogItem():
return $default(_that.id,_that.userId,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.videoWidth,_that.videoHeight,_that.videoAspectRatio,_that.backgroundMusicUrl,_that.backgroundMusicName,_that.soundMode,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.distance,_that.shareType,_that.zan,_that.commentCount,_that.collectCount,_that.shareCount,_that.care,_that.followerCount,_that.creator,_that.creatorName,_that.creatorAvatar,_that.creatorLevel,_that.creatorLevelName,_that.updater,_that.createTime,_that.updateTime,_that.liked,_that.collect,_that.collections,_that.shopProducts);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? userId,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? videoWidth,  int? videoHeight,  double? videoAspectRatio,  String? backgroundMusicUrl,  String? backgroundMusicName,  int? soundMode,  int? addressId,  String? address,  double? latitude,  double? longitude,  double? distance,  int? shareType,  int? zan,  int? commentCount,  int? collectCount,  int? shareCount,  int? care,  int? followerCount,  String? creator,  String? creatorName,  String? creatorAvatar,  int? creatorLevel,  String? creatorLevelName,  String? updater,  String? createTime,  String? updateTime,  int? liked,  int? collect,  List<BlogItemCollection>? collections,  List<BlogItemShopProduct>? shopProducts)?  $default,) {final _that = this;
switch (_that) {
case _BlogItem() when $default != null:
return $default(_that.id,_that.userId,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.videoWidth,_that.videoHeight,_that.videoAspectRatio,_that.backgroundMusicUrl,_that.backgroundMusicName,_that.soundMode,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.distance,_that.shareType,_that.zan,_that.commentCount,_that.collectCount,_that.shareCount,_that.care,_that.followerCount,_that.creator,_that.creatorName,_that.creatorAvatar,_that.creatorLevel,_that.creatorLevelName,_that.updater,_that.createTime,_that.updateTime,_that.liked,_that.collect,_that.collections,_that.shopProducts);case _:
  return null;
...
class _BlogItem implements BlogItem {
  const _BlogItem({this.id, this.userId, this.squareId, this.topicIds, this.categary, this.blogType, this.title, this.content, this.resources, this.coverUrl, this.videoWidth, this.videoHeight, this.videoAspectRatio, this.backgroundMusicUrl, this.backgroundMusicName, this.soundMode, this.addressId, this.address, this.latitude, this.longitude, this.distance, this.shareType, this.zan, this.commentCount, this.collectCount, this.shareCount, this.care, this.followerCount, this.creator, this.creatorName, this.creatorAvatar, this.creatorLevel, this.creatorLevelName, this.updater, this.createTime, this.updateTime, this.liked, this.collect, final  List<BlogItemCollection>? collections, final  List<BlogItemShopProduct>? shopProducts}): _collections = collections,_shopProducts = shopProducts;
...
@override final  String? backgroundMusicUrl;
@override final  String? backgroundMusicName;
@override final  int? soundMode;
...
/// 挂载的店铺商品（团购带货）
 final  List<BlogItemShopProduct>? _shopProducts;
/// 挂载的店铺商品（团购带货）
@override List<BlogItemShopProduct>? get shopProducts {
  final value = _shopProducts;
  if (value == null) return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BlogItem&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.squareId, squareId) || other.squareId == squareId)&&(identical(other.topicIds, topicIds) || other.topicIds == topicIds)&&(identical(other.categary, categary) || other.categary == categary)&&(identical(other.blogType, blogType) || other.blogType == blogType)&&(identical(other.title, title) || other.title == title)&&(identical(other.content, content) || other.content == content)&&(identical(other.resources, resources) || other.resources == resources)&&(identical(other.coverUrl, coverUrl) || other.coverUrl == coverUrl)&&(identical(other.videoWidth, videoWidth) || other.videoWidth == videoWidth)&&(identical(other.videoHeight, videoHeight) || other.videoHeight == videoHeight)&&(identical(other.videoAspectRatio, videoAspectRatio) || other.videoAspectRatio == videoAspectRatio)&&(identical(other.backgroundMusicUrl, backgroundMusicUrl) || other.backgroundMusicUrl == backgroundMusicUrl)&&(identical(other.backgroundMusicName, backgroundMusicName) || other.backgroundMusicName == backgroundMusicName)&&(identical(other.soundMode, soundMode) || other.soundMode == soundMode)&&(identical(other.addressId, addressId) || other.addressId == addressId)&&(identical(other.address, address) || other.address == address)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.distance, distance) || other.distance == distance)&&(identical(other.shareType, shareType) || other.shareType == shareType)&&(identical(other.zan, zan) || other.zan == zan)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount)&&(identical(other.collectCount, collectCount) || other.collectCount == collectCount)&&(identical(other.shareCount, shareCount) || other.shareCount == shareCount)&&(identical(other.care, care) || other.care == care)&&(identical(other.followerCount, followerCount) || other.followerCount == followerCount)&&(identical(other.creator, creator) || other.creator == creator)&&(identical(other.creatorName, creatorName) || other.creatorName == creatorName)&&(identical(other.creatorAvatar, creatorAvatar) || other.creatorAvatar == creatorAvatar)&&(identical(other.creatorLevel, creatorLevel) || other.creatorLevel == creatorLevel)&&(identical(other.creatorLevelName, creatorLevelName) || other.creatorLevelName == creatorLevelName)&&(identical(other.updater, updater) || other.updater == updater)&&(identical(other.createTime, createTime) || other.createTime == createTime)&&(identical(other.updateTime, updateTime) || other.updateTime == updateTime)&&(identical(other.liked, liked) || other.liked == liked)&&(identical(other.collect, collect) || other.collect == collect)&&const DeepCollectionEquality().equals(other._collections, _collections)&&const DeepCollectionEquality().equals(other._shopProducts, _shopProducts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,videoWidth,videoHeight,videoAspectRatio,backgroundMusicUrl,backgroundMusicName,soundMode,addressId,address,latitude,longitude,distance,shareType,zan,commentCount,collectCount,shareCount,care,followerCount,creator,creatorName,creatorAvatar,creatorLevel,creatorLevelName,updater,createTime,updateTime,liked,collect,const DeepCollectionEquality().hash(_collections),const DeepCollectionEquality().hash(_shopProducts)]);
...
as List<BlogItemCollection>?,shopProducts: freezed == shopProducts ? _self._shopProducts : shopProducts // ignore: cast_nullable_to_non_nullable
as List<BlogItemShopProduct>?,
  ));
}
