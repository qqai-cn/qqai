...
mixin _$BlogSaveReqVO {
 ...
 int? get id; int? get squareId; String? get topicIds; int? get categary; int? get blogType; String? get title; String? get content; String? get resources; String? get coverUrl; int? get videoWidth; int? get videoHeight; double? get videoAspectRatio; String? get backgroundMusicUrl; String? get backgroundMusicName; int? get soundMode; int? get addressId; String? get address; double? get latitude; double? get longitude; int? get shareType; List<int>? get collectionIds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,videoWidth,videoHeight,videoAspectRatio,backgroundMusicUrl,backgroundMusicName,soundMode,addressId,address,latitude,longitude,shareType,const DeepCollectionEquality().hash(collectionIds)]);
...
class _BlogSaveReqVO implements BlogSaveReqVO {
  const _BlogSaveReqVO({this.id, this.squareId, this.topicIds, this.categary, this.blogType, this.title, this.content, this.resources, this.coverUrl, this.videoWidth, this.videoHeight, this.videoAspectRatio, this.backgroundMusicUrl, this.backgroundMusicName, this.soundMode, this.addressId, this.address, this.latitude, this.longitude, this.shareType, final  List<int>? collectionIds}): _collectionIds = collectionIds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,videoWidth,videoHeight,videoAspectRatio,backgroundMusicUrl,backgroundMusicName,soundMode,addressId,address,latitude,longitude,shareType,const DeepCollectionEquality().hash(_collectionIds)]);
