...
mixin _$BlogSaveReqVO {
 ...
 int? get id; int? get squareId; String? get topicIds; int? get categary; int? get blogType; String? get title; String? get content; String? get resources; String? get coverUrl; int? get addressId; String? get address; double? get latitude; double? get longitude; int? get shareType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,squareId,topicIds,categary,blogType,title,content,resources,coverUrl,addressId,address,latitude,longitude,shareType);

@override
String toString() {
  return 'BlogSaveReqVO(id: $id, squareId: $squareId, topicIds: $topicIds, categary: $categary, blogType: $blogType, title: $title, content: $content, resources: $resources, coverUrl: $coverUrl, addressId: $addressId, address: $address, latitude: $latitude, longitude: $longitude, shareType: $shareType)';
}
...
@useResult
$Res call({
 int? id, int? squareId, String? topicIds, int? categary, int? blogType, String? title, String? content, String? resources, String? coverUrl, int? addressId, String? address, double? latitude, double? longitude, int? shareType
});
...
/// Create a copy of BlogSaveReqVO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? squareId = freezed,Object? topicIds = freezed,Object? categary = freezed,Object? blogType = freezed,Object? title = freezed,Object? content = freezed,Object? resources = freezed,Object? coverUrl = freezed,Object? addressId = freezed,Object? address = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? shareType = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  int? shareType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BlogSaveReqVO() when $default != null:
return $default(_that.id,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.shareType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  int? shareType)  $default,) {final _that = this;
switch (_that) {
case _BlogSaveReqVO():
return $default(_that.id,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.shareType);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? squareId,  String? topicIds,  int? categary,  int? blogType,  String? title,  String? content,  String? resources,  String? coverUrl,  int? addressId,  String? address,  double? latitude,  double? longitude,  int? shareType)?  $default,) {final _that = this;
switch (_that) {
case _BlogSaveReqVO() when $default != null:
return $default(_that.id,_that.squareId,_that.topicIds,_that.categary,_that.blogType,_that.title,_that.content,_that.resources,_that.coverUrl,_that.addressId,_that.address,_that.latitude,_that.longitude,_that.shareType);case _:
  return null;
...
class _BlogSaveReqVO implements BlogSaveReqVO {
  const _BlogSaveReqVO({this.id, this.squareId, this.topicIds, this.categary, this.blogType, this.title, this.content, this.resources, this.coverUrl, this.addressId, this.address, this.latitude, this.longitude, this.shareType});
