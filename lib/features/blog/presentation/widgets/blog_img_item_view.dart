...
class _BlogImgItemViewState extends ConsumerState<BlogImgItemView> {
  ...
  Widget build(BuildContext context) {
    final blogNotifier = ref.read(blogProvider(widget.category).notifier);
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    widget.blogItem.care == 1 ? '已关注' : '关注',
                    style: TextStyle(
                      fontSize: 13,
                      color: widget.blogItem.care == 1
          ...
          Row(
            children: <Widget>[
              TextButton.icon(
                onPressed: () {
                  ref
                      .read(blogProvider(widget.category).notifier)
