...
class MyVideoListView extends StatefulWidget {
  ...
  const MyVideoListView({required this.tabIndex, required this.currentIndex});

  @override
  State<MyVideoListView> createState() => _TabPageState();
}

class _TabPageState extends State<MyVideoListView>
