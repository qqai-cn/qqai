...
class FullScreenVideoPlayer extends StatefulWidget {
  ...
  const FullScreenVideoPlayer({super.key, this.videoItem});
...
class _FullScreenVideoPlayerState extends State<FullScreenVideoPlayer>
  ...
  late FullVideoEntity? fullVideoEntity;
  late VideoPlayerController controller;

  @override
  void initState() {
    super.initState();
    fullVideoEntity = widget.videoItem as FullVideoEntity?;
    if (fullVideoEntity != null && fullVideoEntity!.controller != null) {
