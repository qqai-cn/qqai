...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<CityMenuModelEntity>[] is M) {
      return data
          .map<CityMenuModelEntity>(
              (Map<String, dynamic> e) => CityMenuModelEntity.fromJson(e))
          .toList() as M;
    }
    if (<CityModelEntity>[] is M) {
      return data
          .map<CityModelEntity>(
              (Map<String, dynamic> e) => CityModelEntity.fromJson(e))
          .toList() as M;
    }
    if (<CityModelLocation>[] is M) {
      return data
          .map<CityModelLocation>(
              (Map<String, dynamic> e) => CityModelLocation.fromJson(e))
          .toList() as M;
    }
    if (<CityModelRefer>[] is M) {
      return data
          .map<CityModelRefer>(
              (Map<String, dynamic> e) => CityModelRefer.fromJson(e))
          .toList() as M;
    }
    if (<DayWeatherEntity>[] is M) {
      return data
          .map<DayWeatherEntity>(
              (Map<String, dynamic> e) => DayWeatherEntity.fromJson(e))
          .toList() as M;
    }
    if (<DayWeatherDaily>[] is M) {
      return data
          .map<DayWeatherDaily>(
              (Map<String, dynamic> e) => DayWeatherDaily.fromJson(e))
          .toList() as M;
    }
    if (<DayWeatherRefer>[] is M) {
      return data
          .map<DayWeatherRefer>(
              (Map<String, dynamic> e) => DayWeatherRefer.fromJson(e))
          .toList() as M;
    }
    if (<HourWeatherEntity>[] is M) {
      return data
          .map<HourWeatherEntity>(
              (Map<String, dynamic> e) => HourWeatherEntity.fromJson(e))
          .toList() as M;
    }
    if (<HourWeatherHourly>[] is M) {
      return data
          .map<HourWeatherHourly>(
              (Map<String, dynamic> e) => HourWeatherHourly.fromJson(e))
          .toList() as M;
    }
    if (<HourWeatherRefer>[] is M) {
      return data
          .map<HourWeatherRefer>(
              (Map<String, dynamic> e) => HourWeatherRefer.fromJson(e))
          .toList() as M;
    }
    if (<HuatiEntity>[] is M) {
      return data
          .map<HuatiEntity>((Map<String, dynamic> e) => HuatiEntity.fromJson(e))
          .toList() as M;
    }
    if (<IdCardBeanEntity>[] is M) {
      return data
          .map<IdCardBeanEntity>(
              (Map<String, dynamic> e) => IdCardBeanEntity.fromJson(e))
          .toList() as M;
    }
    if (<IdCardBeanData>[] is M) {
      return data
          .map<IdCardBeanData>(
              (Map<String, dynamic> e) => IdCardBeanData.fromJson(e))
          .toList() as M;
    }
    if (<IdBeanEntity>[] is M) {
      return data
          .map<IdBeanEntity>(
              (Map<String, dynamic> e) => IdBeanEntity.fromJson(e))
          .toList() as M;
    }
    if (<IdBeanData>[] is M) {
      return data
          .map<IdBeanData>((Map<String, dynamic> e) => IdBeanData.fromJson(e))
          .toList() as M;
    }
    if (<IndicesWeatherEntity>[] is M) {
      return data
          .map<IndicesWeatherEntity>(
              (Map<String, dynamic> e) => IndicesWeatherEntity.fromJson(e))
          .toList() as M;
    }
    if (<IndicesWeatherDaily>[] is M) {
      return data
          .map<IndicesWeatherDaily>(
              (Map<String, dynamic> e) => IndicesWeatherDaily.fromJson(e))
          .toList() as M;
    }
    if (<IndicesWeatherRefer>[] is M) {
      return data
          .map<IndicesWeatherRefer>(
              (Map<String, dynamic> e) => IndicesWeatherRefer.fromJson(e))
          .toList() as M;
    }
    if (<IpBeanEntity>[] is M) {
      return data
          .map<IpBeanEntity>(
              (Map<String, dynamic> e) => IpBeanEntity.fromJson(e))
          .toList() as M;
    }
    if (<IpBeanData>[] is M) {
      return data
          .map<IpBeanData>((Map<String, dynamic> e) => IpBeanData.fromJson(e))
          .toList() as M;
    }
    ...
    if (<MessageAuthor>[] is M) {
      return data
          .map<MessageAuthor>(
              (Map<String, dynamic> e) => MessageAuthor.fromJson(e))
          .toList() as M;
    }
    if (<RealTimeWeatherEntity>[] is M) {
      return data
          .map<RealTimeWeatherEntity>(
              (Map<String, dynamic> e) => RealTimeWeatherEntity.fromJson(e))
          .toList() as M;
    }
    if (<RealTimeWeatherNow>[] is M) {
      return data
          .map<RealTimeWeatherNow>(
              (Map<String, dynamic> e) => RealTimeWeatherNow.fromJson(e))
          .toList() as M;
    }
    if (<RealTimeWeatherRefer>[] is M) {
      return data
          .map<RealTimeWeatherRefer>(
              (Map<String, dynamic> e) => RealTimeWeatherRefer.fromJson(e))
          .toList() as M;
    }
    if (<SkuuBlogPageEntity>[] is M) {
      return data
          .map<SkuuBlogPageEntity>(
              (Map<String, dynamic> e) => SkuuBlogPageEntity.fromJson(e))
          .toList() as M;
    }
    if (<SkuuBlogPageData>[] is M) {
      return data
          .map<SkuuBlogPageData>(
              (Map<String, dynamic> e) => SkuuBlogPageData.fromJson(e))
          .toList() as M;
    }
    if (<SkuuBlogPageDataRecords>[] is M) {
      return data
          .map<SkuuBlogPageDataRecords>(
              (Map<String, dynamic> e) => SkuuBlogPageDataRecords.fromJson(e))
          .toList() as M;
    }
    if (<SkuuBlogSaveEntity>[] is M) {
      return data
          .map<SkuuBlogSaveEntity>(
              (Map<String, dynamic> e) => SkuuBlogSaveEntity.fromJson(e))
          .toList() as M;
    }
    if (<WeatherCityEntity>[] is M) {
      return data
          .map<WeatherCityEntity>(
              (Map<String, dynamic> e) => WeatherCityEntity.fromJson(e))
          .toList() as M;
    }
    if (<WeatherCityData>[] is M) {
      return data
          .map<WeatherCityData>(
              (Map<String, dynamic> e) => WeatherCityData.fromJson(e))
          .toList() as M;
    }
