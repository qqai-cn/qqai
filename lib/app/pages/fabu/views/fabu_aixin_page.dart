...
import 'package:qqai/app/pages/fabu/controllers/fabu_aixin_controller.dart';
...
/// 发布动态
class FabuAiXinPage extends GetView<FabuAiXinController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<FabuAiXinController>(builder: (_) {
      return ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: buildRadioGroupRowWidget(),
          ),
          Divider(
            height: 1,
            color: Colors.black12,
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return ListTile(
                            ...
                            onTap: () {
                              controller
                                  .setWhoCanSee(controller.whoCanSee[index]);
                              Navigator.pop(context);
                            },
                          );
                        },
        ...
        Row(
          ...
          children: [
            Radio(
              ...
              ///当前组中这选定的值  必选参数
              groupValue: controller.aixinType,

              ///点击状态改变时的回调 必选参数
              onChanged: (v) {
                controller.changeAiXinType(v!);
              },
            ),
            Text("聚力")
          ],
