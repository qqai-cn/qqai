...
import 'package:qqai/app/pages/fabu/controllers/fabu_short_video_controller.dart';

import '../../../components/video_player_public/public_video_player.dart';
import '../../index/views/filter_page.dart';

class FabuShortVideoPage extends GetView<FabuShortVideoController> {


  @override
  Widget build(BuildContext context) {
    return GetBuilder<FabuShortVideoController>(builder: (_) {
      return ListView(
