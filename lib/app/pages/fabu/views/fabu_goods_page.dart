...
import '../controllers/fabu_goods_controller.dart';

class FabuGoodsPage extends GetView<FabuGoodsController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<FabuGoodsController>(builder: (_) {
      return ListView(
            ...
            child: Wrap(
              children: [
                ...
                Visibility(
                  ...
                  child: InkWell(
                    onTap: () {
                      _openImageFile(context).then(
                          (value) => {controller.selectFile(value, context)});
                    },
                    child: Icon(
                      Icons.add_box,
                      size: 0.3.sh,
                    ...
                    return Padding(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          AddressEntity addressEntity = controller.addressList[index];
                          ...
                          return ListTile(
                            ...
                            trailing:
                            controller.selAddressEntity?.name == addressEntity.name
                                    ? Icon(Icons.check)
                                    : null,
                            onTap: () {
  ...
  Future<List<XFile>> _openImageFile(BuildContext context) async {
    ...
    if (context.mounted) {
      return Future.value(controller.videoFiles.isNotEmpty ? controller.videoFiles : files);
    }
    return Future.value([]);
  }
}
