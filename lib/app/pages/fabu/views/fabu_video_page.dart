...
import 'package:qqai/app/pages/fabu/controllers/fabu_video_controller.dart';
...
class FabuVideoPage extends GetView<FabuVideoController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<FabuVideoController>(builder: (_) {
      return ListView(
