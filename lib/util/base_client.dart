...
class ApiBaseClient {
  ...
  /// Note: This method logs the error but doesn't show UI since there's no context.
  /// Callers should handle UI display if needed.
  static void handleApiError(ApiException apiException) {
    String msg = apiException.toString();
    // Log the error since we don't have context here
    Logger().e('API Error: $msg');
    // Note: To show error to user, use CustomSnackBar.showCustomErrorToast with context
